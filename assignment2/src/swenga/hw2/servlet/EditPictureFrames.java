...
/**
 * Servlet implementation class EditPictureFrames
 */
@WebServlet("/editPictureFrames")
public class EditPictureFrames extends ThymeleafServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (pictureFramesManager != null) {
			...
			if (pictureFramesModell != null) {
				request.setAttribute("pictureFrames", pictureFramesModell);
				WebContext ctx = new WebContext(request, response, getServletContext(), request.getLocale());
				
				String templateName = "/editPictureFrame.html";
			...
			request.setAttribute("errorMessage", "No Picture Frame with productnumber" + productnumber);
			WebContext ctx = new WebContext(request, response, getServletContext(), request.getLocale());
